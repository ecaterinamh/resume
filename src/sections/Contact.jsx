                    ...
                    <h2 className='contact-title'> CONTACT ______</h2>
                        <Col xs={12} md={6} xl={6} className='contact-content'>
                                <div className='personal-contact'>
                                    ...
                                    <h5 style={{textAlign: 'justify'}}>I would like to connect with you on LinkedIn or GitHub. I'm interested in any new opportunity to work in the web development industry. 
Whether you have a question or just want to say hi, I'll try my best to get back to you! </h5>
                                ...
                                <div className='form-contact'>
                                    <form action='https://getform.io/f/34becda1-3ed4-4bdd-9aa8-244a981dd8c7' method='post'>
                                        <h5 className='mb-3' style={{textAlign: 'justify'}}>I really appreciate if you would like to send me a feedback.</h5>
                                        <h5 className='mb-3'>Thank you!</h5>
                                        <input type="text" id='name' name='name' placeholder='i.e.: name' pattern="^[a-zA-Z]+$" required/>
                                        <input type="text" id='number' name='number' placeholder='i.e.: +0754673231' maxlength='20' pattern="^[0-9]+$" required />
                                        <input type="email" id='email' name='email' placeholder='i.e.: helloworld@gmail.com' pattern="[a-z0-9._%+\-]+@[a-z0-9.\-]+\.[a-z]{2,}$" required/>
